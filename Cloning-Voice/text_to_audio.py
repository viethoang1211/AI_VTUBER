...
class TextToSpeech:
    ...
    def text_to_speech(self, text: str, save: bool = False, file_name='output.wav'):
...
if __name__ == '__main__':
    ...
    tts.text_to_speech('tomorrow is sunday, i will sleep till 9', save=True, file_name='audio_syn/output.wav')